...
(function (global, factory) {
    ...
    */
    ...
    function resolveLocale(locales) {
      try {
        return __spreadArrays$3(Intl.NumberFormat.supportedLocalesOf(locales, {
    ...
    */
    ...
    function formatMessage(_ref, state) {
      ...
      if (!hasValues && "development" === 'production') {
        ...
        invariant$2(val.length === 1 && val[0].type === TYPE.literal, 'Message has placeholders but no values was provided');
        return val[0].value;
      }
      ...
      if (formattedMessageParts.length === 1 && typeof formattedMessageParts[0] === 'string') {
        return formattedMessageParts[0] || defaultMessage || (hasValues ? "".concat(id, " ").concat(JSON.stringify(values)) : id);
      }
    ...
    function (_React$PureComponent) {
      ...
      function IntlProvider() {
        ...
        _this.state = {
          cache: _this.cache,
          intl: createIntl(filterIntlConfig(_this.props), _this.cache),
          prevConfig: filterIntlConfig(_this.props)
        };
        return _this;
      }
      ...
      _createClass(IntlProvider, [{
        ...
        value: function getDerivedStateFromProps(props, _ref) {
          var prevConfig = _ref.prevConfig,
              cache = _ref.cache;
          var config = filterIntlConfig(props);
